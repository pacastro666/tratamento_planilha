App completo em Python com Streamlit
Este app permite:

Importar a planilha Excel via upload.
Selecionar a aba “REAT-10”, extrair todos os números da coluna B (inclusive dentro de sequências com “-”).
Criar/atualizar a aba “EXTRAIDOS_REAT10” com:
NUMERO (únicos em ordem)
ENCONTRADO_REAT10 (fórmula que considera números dentro de sequências)
OCORRENCIAS_REAT10 (quantos consultores contêm o número)
CONSULTORES (lista de consultores onde o número aparece)
Visualizar os dados no Streamlit.
Baixar o arquivo Excel modificado.


Instruções:

Salve o código abaixo em um arquivo, por exemplo: app.py.
Instale dependências: pip install streamlit pandas openpyxl.
